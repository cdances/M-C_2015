...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.60\textwidth]{images/Temporal_Study/Difference_h}
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.60\textwidth]{images/Spatial_Study/Difference_h}
	\caption{Difference Between Succssessive Temporal Refinements}
...
the power fits as seen in figures \ref{fig:Temporal:Diff_h} study
generates at 3 conse points $f_{1}$,$f_{2}$,$f_{3}$ with a constant refinement factor $R$ of 2. The order of accuracy $p$ between 3 points is given by equation \eqref{eq:OOA}.
