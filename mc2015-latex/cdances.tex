...
the inlet to advect to the outlet.The frequency of the sine wave was defined so
...
flow rate $\dot{m}$ use smooth trignometric functions given in equations
...
at each point in time, which omitted the actual ghost cell where these values
