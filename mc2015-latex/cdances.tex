...
\title{Initial 1-D Single Phase Liquid Transient Verification of CTF}
...
\begin{abstract}
Abstract \ldots
When in the course of human events \ldots
...
script in order to reduce user input errors and increase repeatability.
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.75\textwidth]{images/Temporal_Study/Difference_h}
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.75\textwidth]{images/Spatial_Study/Difference_h}
	\caption{Difference Between Succssessive Temporal Refinements}
...
$f_{2}$, $f_{3}$ are consecutive lvels within the same Richardson extrapolation study. The
refinement factor, $R$, has the constnat value of 2 for both the spatial and
temporal studies.
