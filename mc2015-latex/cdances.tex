...
reactor desigin. CTF solves 8 conservation equations for liquid,
...
the intitial comparison of the residual  formulation to the original code.
...
reduced, the numerical error approaches zero. The discretization error
...
study. The refinement factor, $R$, has the constnat value of 2 for both the spatial and
temporal studies.
