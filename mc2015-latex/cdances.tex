...
that corresponds to a 37.5 $^\circ$C temperature change. The time it takes for
the fluid at the inlet to reach the outlet is roughly 
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.60\textwidth]{images/Code_Verification/run_00_00/residual/results/Residuals_Plot}
