...
are made. Only one channel is considred to make the problem 1-D. In order to
make the problem perfectly isobaric and isokinetic, grid spacers losses,
...
fluctuating enthalpy that corresponds to a standard PWR rod bundle coolant
channel. The length of the transient was defined to be quadruple the time needed
for the liquid at the inlet to advect to the outlet. The frequency of the sine
wave was defined to generate a full period of a spatial wave across the length
of the channel.
