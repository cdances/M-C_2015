...
\subsection{Isokinetic Sine Wave Advection}
...
that corresponds to a 37.5 $^\circ$C temperature change.
...
%\begin{figure}[!h]
%	\centering
%	\includegraphics[width=0.55\textwidth]{images/Code_Verification/run_00_00/original/results/Inlet_vel}
%	\caption{Velocity Near the Inlet and the Analytical Solution for the Original
%	Version}
%	\label{fig:Inlet_vel}
%\end{figure}
...
The current version of COBRA-TF uses global code convergance criteria across the
inlet and the entire domain. These approximate the residauls for the equation.
For this problem, the solid energy storate is zero since there are not any heat
structures present. The original convergence criteria in COBRA-TF is shown in
figure \ref{fig:Code_Convergance:Original} and for the residual version in
figure \ref{fig:Code_Convergance:Original}. Note how the residual version has
zero mass storage and fluid energy terms. The other terms are balances across
the inlet and outlet of the problem and follow the sinusodial nature of the
transient. 
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.60\textwidth]{images/Code_Verification/run_00_00/residual/results/Convergence_Plot}
...
figure\ref{fig:Residuals_Plot}.

\begin{figure}[!h]
	\centering
	\includegraphics[width=0.55\textwidth]{images/Code_Verification/run_00_00/residual/results/Residuals_Plot}
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.55\textwidth]{images/Temporal_Study/Difference_m_dot}
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.55\textwidth]{images/Temporal_Study/Difference_h}
	\caption{Difference Between Succssessive Temporal Refinements}
	\label{fig:Temporal:Diff_m_dot}
\end{figure}
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.75\textwidth]{images/Temporal_Study/Order_Of_Accuracy_Summary}
